...
`;
    ...
    function createPanel(cbs) {
        ...
        aboutContent.innerHTML = `
          ...
          <div class="eph-about-name">升学e网通 试卷及习题助手 <span style="font-size:12px;color:#a78bfa;font-weight:600;">v1.0.4</span></div>
          ...
          <div class="eph-about-section">
            ...
            <div class="eph-about-rate-item"><span class="dot"></span> 锁卷取答案改用 homeworkId=0 专用报告，不会污染任务成绩</div>
          </div>
