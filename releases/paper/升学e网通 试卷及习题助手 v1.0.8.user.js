...
// @description  采用志成🍥 的答案获取与风月同天🌸 的脚本参考及UI页面，由⚡Zoan进行整合并支持子母题型 混合题型 并且提供扫描功能，支持检测完成状态，完成禁止再次刷，优化提交功能，进一步优化速度；v1.0.8：锁卷安全机制升级——提交答案优先使用任务已绑定报告（原报告答题），锁卷报告仅作答案源；锁卷前归属检测，部分试卷服务器忽略homeworkId=0时自动放弃锁卷，杜绝生成真实作答报告污染成绩。
// @license      ISC
...
`;
    ...
    function createPanel(cbs) {
        ...
        aboutContent.innerHTML = `
          ...
          <div class="eph-about-name">升学e网通 试卷及习题助手 <span style="font-size:12px;color:#a78bfa;font-weight:600;">v1.0.8</span></div>
