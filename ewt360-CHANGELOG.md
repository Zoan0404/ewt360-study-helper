...
> 🛠 Tampermonkey / Violentmonkey ｜ 📌 **最新版本 v1.0.9** ｜ 🔒 ISC License
>
...
| 版本 | 说明 | 状态 |
| --- | --- | --- |
| [1.0.9](#109---答案获取增强多字段兜底--图片归一化--201查看态候选) | 答案获取增强（多字段兜底 / 图片归一化 / 201查看态候选） | **🆕 最新** |
...
<details>
<summary><b>[1.0.6]</b> - 全量答案接口（webreport 1次请求替代逐题analysis）</summary>
...
<details>
<summary><b>[1.0.5]</b> - 浏览页自动识别：bizCode=201 不再误用，探测真实作答类型</summary>
...
<details>
<summary><b>[1.0.4]</b> - 重刷机制大揭秘：204习题可重做 · 205成绩固化 · 锁卷取答案不再污染成绩</summary>
