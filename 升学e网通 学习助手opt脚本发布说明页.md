...
- **🔀 题型识别修正**：contentTypeName「校本试卷」/ 标题或卡片含「作业提交/校本」/ code=207 的任务，不再硬判 205，正确归入 207 校本报告空间
- **📚 答案/报告读取对齐**：205 与 207 统一走 `/webreport/questionGroup?…&bizCode=&homeworkId=`
- **🔐 锁卷载体迁移到 201 查看态报告**：与任务成绩空间完全隔离，杜绝「时好时坏」污染真实成绩
- **🛡️ 提交满分前归属复核**：服务器复用任务原报告时立即中止，双重防护真实成绩
